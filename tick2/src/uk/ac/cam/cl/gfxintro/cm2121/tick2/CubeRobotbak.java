...
*/
	...
	public void render(Camera camera, float deltaTime, long elapsedTime) {
		...
		body_transform.rotateAffineXYZ(0f, 0.1f * 5 * elapsedTime/1000, 0f, body_transform_time);
...
*/
		...
		Matrix4f arm_transform_time;
		Matrix4f arm_transform = new Matrix4f();
		arm_transform.translate(arm_translate);
		arm_transform.translate(arm_rot_translate);



		arm_transform.rotateAffineXYZ(0f, 0f, time * Math.signum(offset));
		arm_transform.translate(arm_rot_translate.negate());
		arm_transform.scale(arm_scale);

		arm_transform_time = arm_transform;
 ...
 */
		//Matrix4f arm_transform_time = new Matrix4f();
		arm_transform_time.rotateLocal(0.1f * 5 * elapsedTime/1000, 0f, 1f, 0f);

		// TODO: Render Arm.
		renderMesh(camera, arm_mesh, arm_transform_time, arm_shader, arm_texture);
